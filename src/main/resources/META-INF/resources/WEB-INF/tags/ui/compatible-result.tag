...
<c:if test="${version.compatible}">
    <span class="label success">${fn:escapeXml(version)}</span><a class="ui-icon" href="${pageContext.request.contextPath}/proctor/specification?branch=${proctor:urlencode(branch)}&version=${proctor:urlencode(version.appVersion.version)}&app=${proctor:urlencode(version.appVersion.app)}">sp</a>
</c:if>
<c:if test="${!version.compatible}">
    <div class="ui-expand-collapse ui-collapsed">
        ...
        <a class="ui-icon" href="${pageContext.request.contextPath}/proctor/specification?branch=${proctor:urlencode(branch)}&version=${proctor:urlencode(version.appVersion.version)}&app=${proctor:urlencode(version.appVersion.app)}">sp</a>
