        ...
        <c:forEach items="${testMatrix.tests}" var="test">
            ...
            <ui:grid-row extraCssClass="ui-test-definition">
                <ui:grid-columns width="three">
                    <h6 class="mtn"><a class="" href="${pageContext.request.contextPath}/proctor/definition/${proctor:urlencode(test.key)}?branch=${proctor:urlencode(branch.name)}">${fn:escapeXml(test.key)}</a></h6>
                    <ul class="button-group radius">
                        <li><a class="tiny button secondary radius" href="${pageContext.request.contextPath}/proctor/definition/${proctor:urlencode(test.key)}/edit?branch=${proctor:urlencode(branch.name)}">edit</a></li>
                        <%--<li><a class="tiny button secondary radius" href="${pageContext.request.contextPath}/proctor/definition/${test.key}/history">history</a></li>--%>
                        <li><a class="tiny button secondary radius" href="${pageContext.request.contextPath}/proctor/definition/${proctor:urlencode(test.key)}?branch=${proctor:urlencode(branch.name)}">details</a></li>
                    </ul>
